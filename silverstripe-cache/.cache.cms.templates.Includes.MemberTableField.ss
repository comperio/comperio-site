...
SSVIEWER;
 if($item->hasValue("Can",array("inlineadd"))) {  ;
 $val .= <<<SSVIEWER
...
SSVIEWER;
$val .=  $item->obj("AddRecordForm",null,true)->XML_val("CellFields",null,true) ;
 $val .= <<<SSVIEWER

						<td class="actions" colspan="3">
SSVIEWER;
$val .=  $item->obj("AddRecordForm",null,true)->XML_val("CellActions",null,true) ;
 $val .= <<<SSVIEWER
</td>
					</tr>
...
$val .=  $item->XML_val("AddLink",null,true) ;
 $val .= <<<SSVIEWER
" alt="add"><img src="cms/images/add.gif" alt="add" /></a><a class="popuplink addlink" href="
SSVIEWER;
$val .=  $item->XML_val("AddLink",null,true) ;
 $val .= <<<SSVIEWER
" alt="add">
SSVIEWER;
$val .=  _t('MemberTableField.ss.ADDNEW','Add new',50,'Followed by a member type') ;
 $val .= <<<SSVIEWER
...
"><i>
SSVIEWER;
$val .=  _t('MemberTableField.ss.NOITEMSFOUND', 'No items found') ;
 $val .= <<<SSVIEWER
</i></td>
