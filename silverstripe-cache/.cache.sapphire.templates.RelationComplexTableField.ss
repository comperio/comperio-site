...
" alt="
SSVIEWER;
$val .=  _t('RelationComplexTableField.ss.ADD', 'Add') ;
 $val .= <<<SSVIEWER
"><img src="cms/images/add.gif" alt="
SSVIEWER;
$val .=  _t('RelationComplexTableField.ss.ADD', 'Add') ;
 $val .= <<<SSVIEWER
" />
...
"><i>
SSVIEWER;
$val .=  _t('RelationComplexTableField.ss.NOTFOUND', 'No items found') ;
 $val .= <<<SSVIEWER
</i></td>
...
SSVIEWER;
 if($item->hasValue("Can",array("export"))) {  ;
 $val .= <<<SSVIEWER

			<a href="
SSVIEWER;
$val .=  $item->XML_val("ExportLink",null,true) ;
 $val .= <<<SSVIEWER
" target="_blank">
SSVIEWER;
$val .=  _t('RelationComplexTableField.ss.CSVEXPORT', 'Export to CSV' ) ;
 $val .= <<<SSVIEWER
</a>
